...
llamactl is a single-file Python CLI (`llamactl.py`) for managing a local
...
uv run --script llamactl.py --help
...
- **`llamactl.py`** -- entire CLI in one file. Uses Typer for subcommands
